...
Keep the whole thing readable in a minute: one line per bullet, a sentence or
two per section, and the diff left to speak for itself. A description longer
than the change it describes is a sign to cut, not a sign of thoroughness.
