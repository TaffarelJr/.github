...
| :--------------------------------------------------------------- | :-----------------------------: | :-----------------------------: | :---------------------------------------------- |
| 📁[.github/][githubFolder]                                        |                                 |                                 |                                                 |
| &nbsp;├─📁[actions/][ghActionsFolder]                             |               N/A               |                ✅                | [Shared composite actions][releaseFile]         |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─📄[Create Release][createWorkflow]   | Entry point for [cutting a release][releaseFile]. Replaced per layer |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─📄[Release][releaseWorkflow]         | Drafts the release. Shared by every layer                      |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─📄[Template Sync][syncWorkflow]      | Synchronizes files from a template repo to a derived repo       |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└─📄[Validate Codecov][codecovWorkflow] | Checks `codecov.yml` against Codecov's validator                |
...
[githubFolder]: ./.github/
[ghActionsFolder]: ./.github/actions/
